...
@Component({
  selector: 'app-stationaryview-view',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './stationaryview.html',
  styleUrls: ['./stationaryview.css']
})
export class StationaryView implements OnInit {
  products: ProductItem[] = [];
  editingProduct: ProductItem | null = null;
  newProduct: ProductItem = { name: '', price: 0, imageUrl: '', description: '', category: 'BoysWear' };
  loading = false;

  constructor(private productService: StationaryProductService) {}
