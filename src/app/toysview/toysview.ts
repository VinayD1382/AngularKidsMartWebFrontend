...
@Component({
  selector: 'app-toysview-view',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './toysview.html',
  styleUrls: ['./toysview.css']
})
export class ToysView implements OnInit {
  products: ProductItem[] = [];
  editingProduct: ProductItem | null = null;
  newProduct: ProductItem = { name: '', price: 0, imageUrl: '', description: '', category: 'BoysWear' };
  loading = false;

  constructor(private productService: ToysProductService) {}
