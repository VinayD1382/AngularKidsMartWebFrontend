...
export class Games implements OnInit {
  ...
  ngOnInit(): void {
    this.games = [
      { id: 1, name: 'Gun Match Screw', imageUrl: 'Games/o1.png', link: 'https://www.crazygames.com/game/gun-match-screw', price: 0, onSale: true },
      ...
      { id: 2, name: 'Ludo Multiplayer', imageUrl: 'Games/e8.png', link: 'https://poki.com/en/g/ludo-multiplayer', price: 0, onSale: true },
      ...
      { id: 2, name: 'Stunt Bike Extreme', imageUrl: 'Games/e12.png', link: 'https://poki.com/en/g/stunt-bike-extreme', price: 0, onSale: true },
